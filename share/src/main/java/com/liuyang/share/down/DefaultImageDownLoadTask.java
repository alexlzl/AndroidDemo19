...
import com.liuyang.share.utils.IOUtil;
...
public class DefaultImageDownLoadTask extends Thread {
    ...
    public DefaultImageDownLoadTask(String downloadUrl, String filePath, ImageDownLoader.OnImageDownloadListener downLoadListener) {
